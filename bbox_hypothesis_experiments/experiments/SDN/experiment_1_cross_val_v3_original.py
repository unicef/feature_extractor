...
logging.basicConfig(filename=f'/work/alex.unicef/feature_extractor/bbox_hypothesis_experiments/experiments/experiment_{experiment_id}_{info}.log', level=logging.INFO, format='%(asctime)s - %(message)s')
...
school_embedds = np.load('/work/alex.unicef/feature_extractor/bbox_hypothesis_experiments/data/embeddings/DYNOv2_original/school_embeds.npy')
